    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Croissant vuoto',         qty:  60, unitSize:  60, unitLabel: 'crs.'   },
          { name: 'Croissant alla Nutella',  qty:  75, unitSize:  75, unitLabel: 'crs.'   },
          { name: 'Croissant alla crema',    qty:  80, unitSize:  80, unitLabel: 'crs.'   },
          { name: 'Croissant al pistacchio', qty:  80, unitSize:  80, unitLabel: 'crs.'   },
          { name: 'Cornetto integrale',      qty:  65, unitSize:  65, unitLabel: 'corn.'  },
          { name: 'Brioche con tuppo',       qty:  80, unitSize:  80, unitLabel: 'bri.'   },
          { name: 'Succo di frutta brick',   qty: 200, unitSize: 200, unitLabel: 'brick'  },
          { name: 'Yogurt confezionato bar', qty: 125, unitSize: 125, unitLabel: 'yogurt' },
        ],
      },
      {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Magnum Classic',           qty:  86, unitSize:  86, unitLabel: 'Magnum'  },
          { name: 'Magnum Almond',            qty:  90, unitSize:  90, unitLabel: 'Magnum'  },
          { name: 'Ghiacciolo alla frutta',   qty:  75, unitSize:  75, unitLabel: 'ghiac.'  },
          { name: 'Cornetto Algida Classic',  qty:  75, unitSize:  75, unitLabel: 'corn.'   },
          { name: 'Yogurt gelato',            qty: 150, unitSize: 150, unitLabel: 'porz.'   },
          { name: 'Granita con brioche',      qty: 250, unitSize: 250, unitLabel: 'gran.'   },
          { name: 'Frappuccino caffè freddo', qty: 250, unitSize: 250, unitLabel: 'bicc.'   },
          { name: 'Bombolone alla crema',     qty:  80, unitSize:  80, unitLabel: 'bomb.'   },
          { name: 'Muffin cioccolato',        qty: 100, unitSize: 100, unitLabel: 'muffin'  },
        ],
      },
      {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Pizza margherita – intera',       qty: 450, unitSize: 450, unitLabel: 'pizza'  },
          { name: 'Panino hamburger classico',       qty: 200, unitSize: 200, unitLabel: 'pan.'   },
          { name: 'Panino hamburger con cheddar',    qty: 220, unitSize: 220, unitLabel: 'pan.'   },
          { name: 'Patatine fritte',                 qty: 150, unitSize: 150, unitLabel: 'porz.'  },
          { name: 'Piadina prosciutto e stracchino', qty: 180, unitSize: 180, unitLabel: 'piad.'  },
          { name: 'Tramezzino',                      qty: 100, unitSize: 100, unitLabel: 'tram.'  },
          { name: 'Kebab nel pane',                  qty: 300, unitSize: 300, unitLabel: 'kebab'  },
          { name: 'Sushi misto (8 pz)',              qty: 200, unitSize: 200, unitLabel: 'vass.'  },
          { name: 'Pasta al pomodoro – ristorante',  qty: 350, unitSize: 350, unitLabel: 'piatto' },
          { name: 'Insalatona con pollo',            qty: 300, unitSize: 300, unitLabel: 'piatto' },
          { name: 'Wrap pollo e verdure',            qty: 220, unitSize: 220, unitLabel: 'wrap'   },
        ],
      },
    ],
  },
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'Pizza diavola – intera',             qty: 460, unitSize: 460, unitLabel: 'pizza'  },
          { name: 'Pizza 4 formaggi – intera',          qty: 470, unitSize: 470, unitLabel: 'pizza'  },
          { name: 'Burger completo con patatine',       qty: 400, unitSize: 400, unitLabel: 'burger' },
          { name: 'Sushi misto (12 pz)',                qty: 300, unitSize: 300, unitLabel: 'vass.'  },
          { name: 'Tagliata di manzo con rucola',       qty: 300, unitSize: 300, unitLabel: 'piatto' },
          { name: 'Pasta alla carbonara – ristorante',  qty: 380, unitSize: 380, unitLabel: 'piatto' },
          { name: "Pasta all'amatriciana – ristorante", qty: 370, unitSize: 370, unitLabel: 'piatto' },
          { name: 'Risotto ai funghi – ristorante',     qty: 350, unitSize: 350, unitLabel: 'piatto' },
          { name: 'Bistecca ai ferri',                  qty: 200, unitSize: 200, unitLabel: 'bist.'  },
          { name: 'Frittura di pesce',                  qty: 200, unitSize: 200, unitLabel: 'porz.'  },
          { name: 'Tiramisù',                           qty: 150, unitSize: 150, unitLabel: 'porz.'  },
        ],
      },
    ],
  },
